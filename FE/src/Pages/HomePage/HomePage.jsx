...
function HomePage() {
  ...
  const isAuthenticated = useSelector((state) => state.auth.isAuthenticated); // L?y tr?ng thái ??ng nh?p
  ...
  // Theo dõi thay ??i tr?ng thái ??ng nh?p, n?u logout thì ?óng modal
  useEffect(() => {
    if (!isAuthenticated) {
      setVisible(false);
    }
  ...
  return (
    <div>
      ...
      <div className={styles.pageContainer}>
        ...
        {/* Features Section - N?m d??i nh?ng v?n có background */}
