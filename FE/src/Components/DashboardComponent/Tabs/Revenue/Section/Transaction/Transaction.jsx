...
import { GET_REVENUE_BY_TRANSACTIONS_API } from "../../../../../../config/apiConfig";
...
const Transactions = () => {
  ...
  const fetchTransactions = async () => {
    try {
      ...
      const data = await apiCall("GET", GET_REVENUE_BY_TRANSACTIONS_API, null, {
        startDate,
        endDate,
        pageNumber,
        pageSize,
        ...
        <div className={style.card}>
          <div className={style.cardHeader}>
            ...
            <p className={style.statValue}>
              Total Transactions: {response.result.totalTransactions || 0}
            </p>
          </div>
