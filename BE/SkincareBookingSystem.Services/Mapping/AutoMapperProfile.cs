...
public class AutoMapperProfile : Profile
{
    public AutoMapperProfile()
    {
        ...
        CreateMap<CreateSlotDto, Slot>()
            .ForMember(dest => dest.SlotId, opt => opt.Ignore()) // Bỏ qua SlotId vì nó sẽ được tạo tự động
            .ForMember(dest => dest.CreatedTime, opt => opt.MapFrom(src => DateTime.UtcNow)) // Thời gian tạo
            .ForMember(dest => dest.UpdatedTime, opt => opt.Ignore()); // Bỏ qua UpdatedTime

        CreateMap<UpdateSlotDto, Slot>()
            .ForMember(dest => dest.CreatedTime, opt => opt.Ignore()) // Bỏ qua CreatedTime
            .ForMember(dest => dest.UpdatedTime, opt => opt.MapFrom(src => DateTime.UtcNow)); // Cập nhật thời gian
